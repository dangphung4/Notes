...
export const themes = {
  ...
  disciplinarySunCrate: {
    light: {
      background: '32 50% 99%',
      foreground: '32 51% 5%',
      muted: '212 13% 87%',
      mutedForeground: '212 14% 28%',
      popover: '32 50% 99%',
      popoverForeground: '32 51% 5%',
      card: '32 50% 99%',
      cardForeground: '32 51% 5%',
      border: '32 8% 92%',
      input: '32 8% 92%',
      primary: '32 100% 52%',
      primaryForeground: '32 100% 12%',
      secondary: '90 6.56% 76.08%',
      secondaryForeground: '0 0% 100%',
      accent: '298.5 21.05% 62.75%',
      accentForeground: '0 0% 100%',
      destructive: '351.21 69.78% 44.12%',
      destructiveForeground: '351.43 70% 96.08%',
      ring: '31.96 100% 63.92%',
    },
    dark: {
      background: '240 8.2% 11.96%',
      foreground: '351.43 70% 96.08%',
      muted: '212 13% 13%',
      mutedForeground: '212 14% 72%',
      popover: '32 47% 2%',
      popoverForeground: '351.43 70% 96.08%',
      card: '240 7.84% 20%',
      cardForeground: '351.43 70% 96.08%',
      border: '240 8.2% 11.96%',
      input: '351.43 70% 96.08%',
      primary: '32 100% 52%',
      primaryForeground: '210 12.12% 12.94%',
      secondary: '90 6.56% 76.08%',
      secondaryForeground: '210 12.12% 12.94%',
      accent: '298.82 20.82% 48.04%',
      accentForeground: '0 0% 100%',
      destructive: '9 80% 59%',
      destructiveForeground: '0 0% 0%',
      ring: '29.51 100% 88.04%',
  ...
  bleachedLink: {
    light: {
      background: '231 15% 98%',
      foreground: '231 15% 25%',
      muted: '231 12% 92%',
      mutedForeground: '231 12% 45%',
      popover: '231 15% 96%',
    ...
    dark: {
      ...
      input: '231 5% 26%',
      primary: '60 10% 96%',
      primaryForeground: '60 10% 16%',
      secondary: '0 0% 25%',
      secondaryForeground: '0 0% 85%',
      accent: '231 15% 33%',
      accentForeground: '231 15% 93%',
      destructive: '9 81% 57%',
      destructiveForeground: '0 0% 100%',
      ring: '60 10% 96%',
    }
  },
  provincialCalmingRetro: {
    light: {
      background: '29 49% 99%',
      foreground: '29 52% 2%',
      muted: '209 14% 88%',
      mutedForeground: '209 14% 25%',
      popover: '29 49% 98%',
      popoverForeground: '29 52% 1%',
      card: '29 49% 98%',
      cardForeground: '29 52% 1%',
      border: '29 15% 93%',
      input: '29 15% 93%',
      primary: '29 49% 88%',
      primaryForeground: '29 49% 28%',
      secondary: '209 49% 88%',
      secondaryForeground: '209 49% 28%',
      accent: '165.28 49% 88%',
      accentForeground: '209 49% 28%',
      destructive: '18 91% 35%',
      destructiveForeground: '0 0% 100%',
      ring: '29 49% 88%',
    },
    dark: {
